...
export default function CulturalDiscoveryPage() {
  const { getContent, loading, error } = useContent({ page: 'cultural-discovery' });
  ...
  return (
    <UnifiedPackagePage
      packageSlug="cultural-discovery"
      packageName="Cultural Discovery"
      style="pharaonic"
