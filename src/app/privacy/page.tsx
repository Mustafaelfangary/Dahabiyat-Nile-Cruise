    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-amber-800 text-2xl font-bold">𓇳 Loading Royal Decree 𓇳</div>
        </div>
      </div>
    );
  }
      ...
      <section className="relative py-20 bg-gradient-to-br from-amber-900 via-orange-800 to-amber-900 overflow-hidden">
        <Container maxWidth="lg" className="relative z-10">
          <div className="text-center text-white">
            ...
            {/* Main Title */}
            <HieroglyphicText
              text={privacyContent?.title || "Privacy Policy"}
            ...
            >
              𓊪 Royal Decree of Privacy Protection 𓊪
            </Typography>
          </div>
        </Container>
      </section>
